        ...
        <>
            ...
            <section className="relative w-full h-[100dvh] overflow-hidden flex items-center justify-center">
                ...
                <div className="relative z-10 flex flex-col items-center text-center px-4 sm:px-6 lg:px-8">
                    {/* Heading */}
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-black leading-[1.15] drop-shadow-md">
                        {t('title1')}
                        <br />
                    ...
                    <div className="text-center mt-8">
                        <Link
                            href="/shop"
                            className="inline-block text-sm font-semibold uppercase tracking-[0.2em] text-black pb-1 border-b border-black hover:text-amber-400 hover:border-amber-400 transition-colors drop-shadow-sm"
                        >
                            {t('shopNow')}
                        </Link>
                    </div>
