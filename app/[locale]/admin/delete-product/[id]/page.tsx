...
import { SideBarNav } from '@/app/[locale]/admin/sections/SideBarNav';
import { MobileNav } from '@/app/[locale]/admin/sections/MobileNav';
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-4 pt-4 border-t border-stone-800">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-white font-bold text-sm tracking-wide">{product.price.toLocaleString()} L.E</span>
                                    </div>
