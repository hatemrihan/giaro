                ...
                <div className="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p className="text-xs text-stone-400 mt-0.5">
                            Define attribute types like &quot;Weight&quot;, &quot;Flavor&quot;, &quot;Pack Size&quot;, etc.
                        </p>
                    </div>
                    <button
                        type="button"
                ...
                {optionGroups.length === 0 && (
                    <div className="text-center py-10 border border-dashed border-stone-700 rounded-xl">
                        ...
                        <p className="text-xs text-stone-600 mt-1">
                            Add groups to define product attributes (e.g. Weight, Size, Flavor)
                        </p>
                    </div>
                )}
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3 mb-3">
                                <input
                                    ...
                                    placeholder="Group name (e.g. Weight, Flavor, Item)"
