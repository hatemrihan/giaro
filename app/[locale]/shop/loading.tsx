                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex justify-between items-center mb-8 animate-pulse">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="h-4 bg-neutral-100 rounded w-3" />
                            <div className="h-4 bg-neutral-100 rounded w-12" />
                        </div>
                        <div className="flex items-center gap-4">
                            <div className="h-4 bg-neutral-100 rounded w-20 hidden lg:block" />
                    ...
                    <div className="text-center mb-10 animate-pulse">
                        <div className="h-7 bg-neutral-100 rounded w-24 mx-auto" />
                    </div>
